...
namespace MvcDemo.Ajax.Controllers
{
    public class GalleryController : Controller
    {
        ...
        {
            // Skicka med lite intressant information till sidan
        ...
        {
            // Vi returnerar nu en PartialView vid fel
            // Varför? För att vi inte vill rendera formuläret igen!
        ...
        {
            // Nu vill vi istället returnera en PartialView
            // Varför? Jo! För att vi inte vill få med all HTML tillbaka
            // Detta för att listan ska hämtas via JavaScript
            // Efter att vi gjort ett AJAX-anrop
            return PartialView(PhotoRepository.Photos);
        }
    }
}